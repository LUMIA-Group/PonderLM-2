...
def main():
    setup(
        ...
        version=get_version(),
        author="Boyi Zeng",
        description="PonderLM-2: pretraining language models with latent thoughts (ICML 2026 Spotlight)",
        long_description=open("README.md", encoding="utf-8").read(),
        long_description_content_type="text/markdown",
        keywords=[
            "PonderLM-2", "Pondering", "Latent Thoughts", "LLM",
            "Llama", "GPT-NeoX", "Pretraining", "ICML 2026",
        ],
        license="Apache 2.0 License",
        url="https://github.com/hzby/PonderLM-2",
        package_dir={"": "src"},
