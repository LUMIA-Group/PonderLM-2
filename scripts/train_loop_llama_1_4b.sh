#!/bin/bash
# Reproduce the Loop baseline on Llama-1.4b — Table 3 of the paper.
# Total tokens: 50_000 * 4 * 16 * 2048 ≈ 6.5B tokens.

set -e

OUTPUT_DIR=${OUTPUT_DIR:-saves/smallpile/loop_llama_1.4b}
